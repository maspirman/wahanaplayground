...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>About - Wahana Playground</title>
						...
						<div class="row col-mb-50">
							<div class="col-sm-6 col-lg-3">
								<div class="feature-box fbox-center fbox-bg fbox-plain">
									...
									<div class="fbox-content">
										<h3>Our Headquarters<span class="subtitle"><?= $q['address'] ?></span></h3>
							...
							<div class="col-sm-6 col-lg-3">
								<div class="feature-box fbox-center fbox-bg fbox-plain">
									...
									<div class="fbox-content">
										<h3>Call Us<span class="subtitle"><?= $q['phone'] ?></span></h3>
							...
							<div class="col-sm-6 col-lg-3">
								<div class="feature-box fbox-center fbox-bg fbox-plain">
									...
									<div class="fbox-content">
										<h3>Follow on Instagram<span class="subtitle"><?= $q['ig'] ?></span></h3>
							...
							<div class="form-widget">
								...
								<form class="mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
									...
									<div class="row">
										...
										<div class="col-12 form-group">
											<button name="submit" type="submit" id="submit-button" tabindex="5" value="Submit" class="button button-3d m-0">Submit Message</button>
										</div>
									</div>
