...
if (isset($_POST['gambar'])) {
  ...
  if ($set > 0) {
    ...
    echo "<script>
            ...
            window.location.href='index.php?p=product-adventure-playground';
          </script>";
  }
}
...
<div class="card m-3">
  ...
  <div class="card-header border-0">
    <div class="row">
      <div class="col-6">
        <h3 class="mb-0">Table Adventure Playground</h3>
      </div>
      <!-- Modal Button -->
                  ...
                  <?php foreach ($media as $row) : ?>
                    <div class="col-lg-4 mt-1 ">
                      ...
                      <div class="card card-profile">
                        <img src="<?= BASE_URL; ?>assets/img/wahana/<?= $row['pict_name']; ?>" alt="Image placeholder" class="card-img-top" width="200px" height="150px">
  ...
  <!-- Light Table -->
  <?php $adventure = query("SELECT tbl_media.pict_name, tbl_media.alt, tbl_product.time FROM tbl_media INNER JOIN tbl_product ON tbl_media.id_media=tbl_product.id_media WHERE tbl_product.target='adventure_playground' ORDER BY time DESC")[0]; ?>
        ...
        <?php foreach ($adventure as $r) : ?>
          <tr>
            ...
            <td class="table-actions">
              <a href="index.php?p=product-adventure-playground&delete=<?= $r['time'] ?>" class="table-action table-action-delete" data-toggle="tooltip" data-original-title="Delete client">
